...
onEvent('recipes', event => {
	...
	event.recipes.createSequencedAssembly([
        ...
        event.recipes.create.splashing([Item.of("kubejs:popcorn_kernel").withChance(0.5), Item.of('botania:overgrowth_seed').withChance(0.01), Item.of('minecraft:wheat_seeds').withChance(0.3)], 'kubejs:dirt_piece')
